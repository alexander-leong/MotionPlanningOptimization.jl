...
begin
	...
	function solve_for_optimal_path(N)
	  ...
	  return model, solve_time.time, x, y, z, x′, y′, z′, x″, y″, z″, x‴, y‴, z‴
	end
end
...
# ╔═╡ f67d1ac2-28a4-11ef-36f6-3b871aff3190
begin
	using GLMakie
...
git-tree-sha1 = "a697c4d3e0037fc6d058d527617a4aa46d5761e5"
...
git-tree-sha1 = "6b286f829dccc8b080ed34a99cb39abea0afb6ca"
...
[[deps.Pajarito]]
deps = ["JuMP", "LinearAlgebra", "MathOptInterface", "Printf", "SparseArrays"]
git-tree-sha1 = "633d7e4c6b1ae99917787d4383cc6941e0849ef2"
...
[[deps.PolyJuMP]]
deps = ["DataStructures", "DynamicPolynomials", "JuMP", "LinearAlgebra", "MathOptInterface", "MultivariateBases", "MultivariateMoments", "MultivariatePolynomials", "MutableArithmetics", "SemialgebraicSets"]
git-tree-sha1 = "9a7d96a46320c673a0296cc75d7c6a63918dc4f2"
...
git-tree-sha1 = "e2ef2a54ae1a51fc4c5b0c92e3d9ec9e05296e7f"
